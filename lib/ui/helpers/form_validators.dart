...
extension EmailErrorMessageExtension on Email {
  String get errorMessage {
    ...
    if (this.error == EmailValidationError.invalid) return 'የማይሰራ E-mail';
    return this.error == EmailValidationError.empty ? 'መሞላት ያለበት' : null;
  }
}
...
extension PasswordErrorMessageExtension on Password {
  String get errorMessage {
    ...
    if (this.error == PasswordValidationError.invalid)
      return 'የይለፍ ቃል በጣም አጭር ነው';
    return this.error == PasswordValidationError.empty ? 'መሞላት ያለበት' : null;
  }
}
...
extension NameInputErrorMessageExtension on NameInput {
  String get errorMessage {
    ...
    if (this.error == NameValidationError.invalid) return 'በጣም አጭር ስም';
    return this.error == NameValidationError.empty ? 'መሞላት ያለበት' : null;
  }
}
...
extension MessageInputErrorMessageExtension on MessageInput {
  String get errorMessage {
    ...
    return this.error == MessageValidationError.empty ? 'መሞላት ያለበት' : null;
  }
}
